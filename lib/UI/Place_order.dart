...
class _Place_OrderState extends State<Place_Order> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        actions: [
          Icon(Icons.more_vert),SizedBox(width: 20,)
        ],
      ),
      body: Padding(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              Row(
                                children: [
                                  Text('Street : ',style: TextStyle( fontSize: 18.sp,
                                    color: Colors.black,
                                    fontWeight: FontWeight.w600,),),
                                ...
                                Row(
                                  children: [
                                    Text('State/Province/Area : ',style: TextStyle( fontSize: 18.sp,
                                      color: Colors.black,
                                      fontWeight: FontWeight.w600,),),
                                    Text('Tmail Nadu')
                                  ],
                                ...
                                Row(
                                  children: [
                                    Text('Zip Code : ',style: TextStyle( fontSize: 18.sp,
                                      color: Colors.black,
                                      fontWeight: FontWeight.w600,),),
                                    Text('658214')
                                  ],
                                ...
                                Row(
                                  children: [
                                    Text('Country Calling Code : ',style: TextStyle( fontSize: 18.sp,
                                      color: Colors.black,
                                      fontWeight: FontWeight.w600,),),
                                    Text('+ 91')
                                  ],
                                ...
                                Row(
                                  children: [
                                    Text('Country : ',style: TextStyle( fontSize: 18.sp,
                                      color: Colors.black,
                                      fontWeight: FontWeight.w600,),),
                                    Text('India')
                                  ],
